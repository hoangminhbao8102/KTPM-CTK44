        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VE_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VE_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_THANH_TOAN_VE_TicketId",
                        column: x => x.TicketId,
                        principalTable: "VE",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_THANH_TOAN_TicketId",
                table: "THANH_TOAN",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_VE_CustomerId",
                table: "VE",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_VE_ScheduleId",
                table: "VE",
                column: "ScheduleId");
        }
